...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ajax: 'https://raw.githubusercontent.com/MOSQUEDACORDOVA/senhub_facturacion/main/app-assets/data/table-datatable-copy.json',
      columns: [
        { data: 'responsive_id' },
        { data: 'id' },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $status = {
              0: { title: 'Pendiente', class: 'badge-light-warning' },
              1: { title: 'Activo', class: ' badge-light-success' },
              2: { title: 'Inactivo', class: ' badge-light-secondary' },
            };
        ...
        
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a class="pe-0 dropdown-toggle hide-arrow text-primary" data-bs-toggle="dropdown">' +
      ...
      buttons: [
        {
          extend: 'collection',
          className: 'btn btn-primary dropdown-toggle me-0',
